...
//     than and greater than pivot. The relative order of the elements less than
//     pivot and the elements greater than pivot is maintained.
//         More formally, consider every pi, pj where pi is the new position of
//         the ith element and pj is the new position of the jth element. If i <
//         j and both elements are smaller (or larger) than pivot, then pi < pj.
...
int main(int argc, char *argv[]) {
    ...
    for (auto &[test, ans] : tests) {
        auto result = solution.pivotArray(test.first, test.second);
