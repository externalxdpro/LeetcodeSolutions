...
//     tokeni, losing tokens[i] power and gaining 1 score. Face-down: If your
//     current score is at least 1, you may play tokeni, gaining tokens[i] power
//     and losing 1 score.
...
//     to 1. Play token3 (400) face-down, increasing power to 500 and reducing
//     score to 0. Play token1 (200) face-up, reducing power to 300 and
//     increasing score to 1. Play token2 (300) face-up, reducing power to 0 and
//     increasing score to 2.
...
int main(int argc, char *argv[]) {
    ...
    for (auto &[test, ans] : tests) {
        auto result = solution.bagOfTokensScore(test.first, test.second);
