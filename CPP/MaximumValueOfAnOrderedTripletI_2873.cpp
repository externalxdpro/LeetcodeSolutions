...
// nums[4] = 77. It can be shown that there are no ordered triplets of indices
...
// nums[4] = 133. It can be shown that there are no ordered triplets of indices
...
int main(int argc, char *argv[]) {
    ...
    for (auto &[test, ans] : tests) {
        auto result = solution.maximumTripletValue(test);
