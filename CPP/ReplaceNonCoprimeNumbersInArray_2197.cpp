...
//     Common Multiple). Repeat this process as long as you keep finding two
...
class Solution {
  ...
  private:
    int lcm(int x, int y) { return x / std::gcd(x, y) * y; }
};
...
int main(int argc, char *argv[]) {
    ...
    for (auto &[test, ans] : tests) {
        auto result = solution.replaceNonCoprimes(test);
