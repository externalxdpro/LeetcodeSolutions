...
//     value equal to vali. nums2[i] = [idi, vali] indicate that the number with
...
//     in the resulting array. Each id should be included only once and its
//     value should be the sum of the values of this id in the two arrays. If
//     the id does not exist in one of the two arrays, then assume its value in
//     that array to be 0.
...
int main(int argc, char *argv[]) {
    ...
    for (auto &[test, ans] : tests) {
        auto result = solution.mergeArrays(test.first, test.second);
