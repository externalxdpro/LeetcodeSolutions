...
//     should be an actual node in the list. We will build the linked list and
//     pass the node to your function. The output will be the entire list after
...
int main(int argc, char *argv[]) {
    // i have no idea how to make test cases for this one
