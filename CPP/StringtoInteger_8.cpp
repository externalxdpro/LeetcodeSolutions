...
int myAtoi(std::string s)
{
    ...
    for (int i = 0; i < s.length(); i++)
    {
        ...
        if (result > std::numeric_limits<int>::max() / 10 ||
            (result == std::numeric_limits<int>::max() / 10 && s[i] - '0' > 7))
        {
            if (sign) return std::numeric_limits<int>::max();
...
{
    std::cout << myAtoi("-123") << '\n';
    std::cout << myAtoi("12345678910") << '\n';
    std::cout << myAtoi("-91283472332") << '\n';
    std::cout << myAtoi("123 with words") << '\n';
    std::cout << myAtoi("") << '\n';
    std::cout << myAtoi(" ") << '\n';
    std::cout << myAtoi(" -1010023630o4") << '\n';
}
